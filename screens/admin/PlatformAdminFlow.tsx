...
type Tab = 'documents' | 'payments' | 'tournaments';

/** Home del platform_admin: revisión de documentos de coaches (flujo original), verificación de
 * pagos manuales (fase 1 sin Stripe, ver paymentService.submitPaymentProof/verifyPayment) y
 * sembrar torneos sin club (ver decisión #36 en db/schema.sql). Responsabilidades sin relación
