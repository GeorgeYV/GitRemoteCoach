/** Espejado en server/src/lib/matchFormats.ts (mismo contenido, sin dependencias de React) —
 * fuente de verdad de las reglas de cada formato de partido. La base de datos (matches.format,
 * ver decisión #37 en db/schema.sql) solo guarda el id; estas reglas nunca se persisten. */
 ...
 * scoringEngine.ts junto al resto de las reglas de un game/set regular). */
